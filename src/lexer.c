...
Token lexer_next(Lexer *l) {
    ...
    if (isident(*l->sv.data)) {
        ...
        if (sv_match(token.sv, "nil")) {
            token.kind = TOKEN_NIL;
        } else if (sv_match(token.sv, "true")) {
        ...
        } else if (sv_match(token.sv, "match")) {
        ...
        } else if (sv_match(token.sv, "when")) {
            token.kind = TOKEN_WHEN;
        } else {
    ...
    case '#':
        ...
        if (sv_match(token.sv, "#OS")) {
            token.kind = TOKEN_PROP_OS;
        } else if (sv_match(token.sv, "#link")) {
            token.kind = TOKEN_PROP_LINK;
        } else {
